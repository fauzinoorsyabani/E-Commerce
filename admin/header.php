...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="index.php" class="logo">
			<span class="logo-lg">Ecomart</span>
		</a>
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview <?php
				if(
					$cur_page == 'size.php' || $cur_page == 'size-add.php' || 
					$cur_page == 'size-edit.php' || $cur_page == 'color.php' ||
					$cur_page == 'color-add.php' || $cur_page == 'color-edit.php' ||
					$cur_page == 'country.php' || $cur_page == 'country-add.php' ||
					$cur_page == 'country-edit.php' || $cur_page == 'shipping-cost.php' ||
					$cur_page == 'shipping-cost-edit.php' || $cur_page == 'top-category.php' ||
					$cur_page == 'top-category-add.php' || $cur_page == 'top-category-edit.php' ||
					$cur_page == 'mid-category.php' || $cur_page == 'mid-category-add.php' ||
					$cur_page == 'mid-category-edit.php' || $cur_page == 'end-category.php' ||
					$cur_page == 'end-category-add.php' || $cur_page == 'end-category-edit.php'
				) echo 'active';
			?>">
				<a href="#">
			...
			<li class="treeview <?php if($cur_page == 'customer.php') echo 'active'; ?>">
				<a href="customer.php">
			...
			<!-- SECURITY LOGS -->
			<li class="treeview <?php if($cur_page == 'logs.php') echo 'active'; ?>">
			    <a href="logs.php">
			        <i class="fa fa-shield"></i> <span>Security Logs</span>
			    </a>
			</li>
