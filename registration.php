...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        // DEFAULT country untuk kolom billing dan shipping (wajib INT)
        $default_country = 1; // pastikan country_id = 1 ada di tbl_country
            ...
            <form action="" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea name="cust_address" class="form-control" style="height:70px;"></textarea>
                    </div>
